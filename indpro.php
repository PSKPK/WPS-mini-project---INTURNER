...
<html lang="en" dir="ltr">
  ...
  <body style="background-color: #CCFAFF;">
      ...
      <?php
        ...
        if(mysqli_num_rows($projs)==0){
          ...
          for($i=0; $i<mysqli_num_rows($projs); $i++){
            $url = mysqli_fetch_array($projs)[0];
      ...
      <?php
        ...
        if(mysqli_num_rows($tids)==0){
          ...
          for($i=0; $i<mysqli_num_rows($tids); $i++){
            ...
            echo mysqli_fetch_array(mysqli_query($conn,"select name from `profs` where tid=".$tid.";"))[0];
            echo "</a></li>";
          }
          echo "</ul>";
        }
    ...
    <br><br>
    <center><button><a href="http://localhost/INTurner/searchteam.php" target='_blank' style='text-decoration:none;color: black; font-size:30px;'>Search teams </a></button></center>
    <center><button><a href="http://localhost/INTurner/editindi.php" target='_blank' style='text-decoration:none;color: black; font-size:30px;'>Edit profile</a></button></center>
